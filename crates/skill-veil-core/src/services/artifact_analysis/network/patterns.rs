...
lazy_pattern!(pub(super) RE_HTTP_URL, r#"https?://[^\s"'`)]+"#);
lazy_pattern!(pub(super) RE_RFC1918_10, r"\b10\.\d{1,3}\.\d{1,3}\.\d{1,3}\b");
lazy_pattern!(pub(super) RE_RFC1918_192, r"\b192\.168\.\d{1,3}\.\d{1,3}\b");
lazy_pattern!(
    pub(super) RE_RFC1918_172,
    r"\b172\.(1[6-9]|2\d|3[0-1])\.\d{1,3}\.\d{1,3}\b"
);
lazy_pattern!(
    pub(super) RE_INTERNAL_ACTION,
...
lazy_pattern!(
    pub(super) RE_LOCAL_DEV_REFERENCE,
...
lazy_pattern!(
    pub(super) RE_LOCAL_CONTROL_PLANE,
...
lazy_pattern!(
    pub(super) RE_OPTIONAL_WEBHOOK_DOCS,
